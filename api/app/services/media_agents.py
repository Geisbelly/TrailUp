...
_BRAINHEX_GUIDE_CONFIG: dict[str, dict[str, str]] = {
    ...
    "seeker":     {"guia_nome": "Amara",  "guia_voz": "Leda",   "guia_cor": "#a78c07", "framing": "Crônicas da Exploração",    "label": "Explorador"},
    "survivor":   {"guia_nome": "Kenji",  "guia_voz": "Schedar", "guia_cor": "#720101", "framing": "Diretrizes de Campo",       "label": "Sobrevivente"},
    ...
    "socializer": {"guia_nome": "Mateo",  "guia_voz": "Achird", "guia_cor": "#6d15be", "framing": "Elo da Comunidade",         "label": "Socializador", "guia_nome_secundario": "Zuri", "guia_voz_secundario": "Sulafat"},
    "achiever":   {"guia_nome": "Kwame",  "guia_voz": "Orus",   "guia_cor": "#ad6002", "framing": "Caminho da Maestria",       "label": "Realizador"},
}
