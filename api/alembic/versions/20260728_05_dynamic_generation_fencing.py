"""make generation fencing independent from hardcoded pipeline versions
...
def downgrade() -> None:
    # As revisoes anteriores congelam contratos de pipeline ja obsoletos.
    # Reinstala-las em downgrade voltaria a recusar apresentacoes atuais.
    pass
