...
const icons = { resumo: "text-box-outline", anotacao: "note-text-outline", card: "cards-outline", loja: "shopping-outline" } as const;
const labels = { resumo: "RESUMO", anotacao: "ANOTAÇÃO", card: "CARD", loja: "LOJA" } as const;
      ...
      <Pressable onPress={() => setExpanded((value) => !value)} style={styles.header}>
        ...
        <View style={styles.titleArea}>
          <View style={styles.metaRow}>
            ...
            <Text style={[styles.origin, { color: muted }]}>{item.origin === "aluno" ? "MEU ITEM" : item.origin === "loja" ? "COMPRADO" : "GERADO"}</Text>
          </View>
