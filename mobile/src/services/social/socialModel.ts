...
export type SocialPerson = { alunoId: string; nome: string; apelido: string | null; fotoUrl: string | null; perfilAtivo: string | null; status: SocialStatus; relationshipId: string | null; guildaId: string | null; guildaNome: string | null };
