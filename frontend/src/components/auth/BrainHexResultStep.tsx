  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {representativeProfiles.map((profile) => {
              ...
              return (
                ...
                >
                  <span className="rounded-lg border border-white/10 bg-background/60 p-2">
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className="text-xs text-muted-foreground">{profile.percent}% de afinidade</span>
                  </span>
                  {selected && (
      ...
      <div className="group relative">
        ...
        <Card
          className={cn(
            "relative overflow-hidden border bg-card/50 p-6 backdrop-blur-xl",
            config.cardStyle,
          )}
        >
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="flex h-20 w-20 items-center justify-center rounded-lg border border-white/10 bg-background/50 shadow-lg">
            ...
            <div className="mt-2 h-4 w-full rounded-full border border-white/5 bg-background/50 p-0.5">
              <div
              ...
              >
                ...
                <div className="flex-1 space-y-1.5">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-mono text-xs text-muted-foreground">{profile.percent}%</span>
                  </div>
                  <Progress
